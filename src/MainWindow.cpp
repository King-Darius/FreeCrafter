...

{
    ...
    const QString timestamp = locale.toString(latest->timestamp.toLocalTime(), QLocale::LongFormat);
...

{
    ...
    if (measurementWidget)
        ...
        measurementWidget->setHint(Measurement::measurementHintForKind(kind));
...

{
    ...
    Measurement::ParseResult parsed = Measurement::parseMeasurement(value, unitSystem, kind);
