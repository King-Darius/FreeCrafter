...
- **UI, tools, and interaction contracts (binding)**
  ...
  - `docs/codex_master_ui_tools_spec.md` — stack-agnostic contract mirroring the GUI spec; keep IDs/timings consistent across platforms.
...
1. **Update the closest existing source** instead of creating a parallel document. Example: UI/interaction changes belong in `docs/gui_tool_behaviour_spec.md` and, if cross-stack, in `docs/codex_master_ui_tools_spec.md`.
