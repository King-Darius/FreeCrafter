...
private slots:
    ...
    void activateScale();
    void activateOffset();
    void activatePushPull();
    void activateFollowMe();
    ...
    void activateText();
    void activateDimension();
    void activateTapeMeasure();
    void activateProtractor();
    void activateAxes();
    void activatePan();
    void activateOrbit();
    void activateZoom();
...
private:
    ...
    QAction* offsetAction = nullptr;
    QAction* pushPullAction = nullptr;
    QAction* followMeAction = nullptr;
    QAction* extrudeAction = nullptr;
    QAction* chamferAction = nullptr;
    QAction* loftAction = nullptr;
    QAction* sectionAction = nullptr;
    QAction* paintBucketAction = nullptr;
    QAction* textAction = nullptr;
    QAction* dimensionAction = nullptr;
    QAction* tapeMeasureAction = nullptr;
    QAction* protractorAction = nullptr;
    QAction* axesAction = nullptr;
